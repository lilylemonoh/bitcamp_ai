...
model.fit(
    ...
    # eval_metric = 'error' 
    # # CatBoostClassifier, LGMBClassifier는 ever_metric 제거해야 함
)
...
# 3. model = LGBMClassifier() 사용했을 때 일반적인 값-------------------------------------
# score : [0.85872914 0.86338004 0.86073079 0.86337606 0.86075986]
# acc : 0.8568192300387965
...
# Thresh=55.000, n=10, ACC:85.85%
# ['ID', 'Gender', 'Age', 'Region_Code', 'Occupation', 'Channel_Code', 'Vintage', 'Credit_Product', 'Avg_Account_Balance', 'Is_Active']
# Thresh=555.000, n=1, ACC:76.11%
# ['Age']
# Thresh=297.000, n=6, ACC:78.66%
# ['ID', 'Age', 'Region_Code', 'Occupation', 'Vintage', 'Avg_Account_Balance']

# Thresh=327.000, n=5, ACC:78.63%
# ['ID', 'Age', 'Occupation', 'Vintage', 'Avg_Account_Balance']
# Thresh=138.000, n=7, ACC:78.68%
# ['ID', 'Age', 'Region_Code', 'Occupation', 'Channel_Code', 'Vintage', 'Avg_Account_Balance']
# Thresh=489.000, n=2, ACC:76.47%
# ['Age', 'Vintage']
# Thresh=128.000, n=8, ACC:85.66%
# ['ID', 'Age', 'Region_Code', 'Occupation', 'Channel_Code', 'Vintage', 'Credit_Product', 'Avg_Account_Balance']
# Thresh=462.000, n=3, ACC:76.47%
# ['Age', 'Vintage', 'Avg_Account_Balance']
# Thresh=114.000, n=9, ACC:85.85%
# ['ID', 'Age', 'Region_Code', 'Occupation', 'Channel_Code', 'Vintage', 'Credit_Product', 'Avg_Account_Balance', 'Is_Active']
